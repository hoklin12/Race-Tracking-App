...
//         children: [
//           _buildEmptyPositionItem(const Color.fromARGB(255, 199, 199, 199)), // 2nd
//           _buildEmptyPositionItem(Colors.amber), // 1st
//           _buildEmptyPositionItem(Colors.brown), // 3rd
//         ],
//       );
//     }
...
//         mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//         children: [
//           _buildEmptyPositionItem(Colors.grey), // 2nd
//           _buildEmptyPositionItem(Colors.amber), // 1st
//           _buildEmptyPositionItem(Colors.brown), // 3rd
//         ],
//       );
...
//         if (reorderedParticipants[index].isNotEmpty) {
//           final participant = reorderedParticipants[index];
//           final position = index == 1 ? 1 : (index == 0 ? 2 : 3);
